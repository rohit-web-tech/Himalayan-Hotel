...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col w-full sticky top-0 z-50">
      <div className="w-100 h-auto bg-[--primary-color] py-2 border-b-[1px] border-[--secondary-color] hidden sm:block">
        <ContentWrapper>
          <div className="flex  flex-col items-center gap-2 justify-between sm:flex-row sm:gap-0">
            <div className="flex flex-wrap items-center justify-center gap-2 sm:flex md:gap-7 sm:gap-3">
            ...
            <div className="flex items-center gap-4 text-[--secondary-color] md:gap-4 sm:gap-2">
      ...
      <div className="w-100 h-auto bg-[--primary-color] py-2">
        <ContentWrapper>
          ...
          {
            showSideNav && (
              <ul className="flex w-[100%] flex-wrap mt-5 items-center justify-between gap-4 text-sm text-[--secondary-color] cursor-pointer sm:hidden">
